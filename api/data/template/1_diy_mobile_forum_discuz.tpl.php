...
0
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/header.htm', 1709097729, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', './template/default', 'mobile/forum/discuz')
|| checktplrefresh('./template/default/mobile/forum/discuz.htm', './template/default/mobile/common/footer.htm', 1709097729, 'diy', './data/template/1_diy_mobile_forum_discuz.tpl.php', './template/default', 'mobile/forum/discuz')
;?>
...
<p><a href="<?php echo $nav;?>">首页</a><span class="pipe">|</span>简易版<span class="pipe">|</span><a href="<?php echo $_G['setting']['mobile']['simpletypeurl']['2'];?>" class="xw0" title="触屏版">触屏版</a><span class="pipe">|</span><a href="<?php echo $_G['setting']['mobile']['nomobileurl'];?>" class="xw0" title="电脑版">电脑版</a></p>
</div>
</body>
